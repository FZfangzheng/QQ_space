<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Friend_recommend.aspx.cs" Inherits="Friend_recommend" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Repeater ID="rptfriendcommend" runat="server" OnItemCommand="rptfriendcommend_ItemCommand" >
            <HeaderTemplate> 
                <table>
            </HeaderTemplate>
            <ItemTemplate>
                <tr>
                    <td>
                        <%# Eval("nickname") %>
                         <asp:LinkButton ID="friendspace" runat="server" Text=' <%# Eval("username") %>' CommandName="Friendspace" CommandArgument=' <%# Eval("username") %>'></asp:LinkButton>
